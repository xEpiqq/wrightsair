...
function Duct_cleaning() {
  ...
  return (
    ...
    <div className='ac_repair_one'>
      ...
      <div className='ac_repair_one_title'><h1>AIR DUCT CLEANING</h1></div>
      <div className='ac_repair_one_main'>
        <div className='ac_repair_one_main_left'>
          <h1>We will clean your air ducts!</h1>
          ...
          system is functioning flawlessly, without a clean path for the
          air to flow through your ducts, <span>the efficiency of your system is
          decreased</span> drastically. That’s why we at Wright’s Air 
          Systems are here to clean your air ducts,</p>
        </div>
      ...
      <div className='ac_repair_one_mid_div'>
          ...
          <div className='ac_repair_one_mid_right'>
            <h2>If it's time for cleaning,</h2>
      ...
      <div className='ac_repair_one_bottom'>
        <div className='ac_repair_one_bottom_top'>
          <h1>Is It Time To Clean Your Air Ducts?</h1>
          <p>There are many signs that your air ducts need to be cleaned. If you find dust increasing in the air of your home,
          energy bills flying a little higher than usual, mold growing in your air ducts, or pests finding their way into unbelievable
          places… it might be time to clean your air ducts, here are some of the common signs that it is time to clean your air 
          ducts.<span> Read below for some more information,</span></p>
        </div>
        <div className='ac_repair_one_list'>
          <img src={green_check_two} />
          <div className='ac_repair_one_text'>
            <p><span>DUSTY AIR —</span> One of the most recognizable signs that your air ducts need to be cleaned is dusty indoor air. To breathe it is not healthy or pleasant. As the debris in your ducts increases so does the residual debris in the air.</p>
          </div>
        </div>
        <div className='ac_repair_one_list'>
          <img src={green_check_two} />
          <div className='ac_repair_one_text'>
            <p><span>CLIMBING BILLS —</span> Uncleaned air ducts can get really dirty after years without maintenance. Energy bills are the consequence, and they begin to climb fast as the efficiency of your hvac system is reduced drastically.</p>
          </div>
        </div>
        <div className='ac_repair_one_list'>
          <img src={green_check_two} />
          <div className='ac_repair_one_text'>
            <p><span>INFESTATION —</span> Strange little furry creatures nesting, bugs enjoying their brand-new-home, infestation is a real problem that many with dirty ducts experience. We’ll take care of em’ for you.</p>
          </div>
        </div>
        <div className='ac_repair_one_list'>
          <img src={green_check_two} />
          <div className='ac_repair_one_text'>
            <p><span>MOLD —</span> Not only does it cause awful odor, it is really dangerous for your health. Mold is a very clear sign that your air ducts need to be cleaned--for the safety of you and your family.</p>
          </div>
        </div>
      </div>
      <div className='ac_repair_one_very_bottom'>
          <div className='is_it_time'>
            <h1>IS IT TIME TO CLEAN <span>YOUR AIR DUCTS? WE HAVE YOUR BACK</span></h1>
            <div className='is_it_time_btn'>
              <button onClick={() => modalIncrement()}>SCHEDULE</button>
            </div>
          </div>
          <div className='guarantee_box'>
            <Guarantee t1='Provide the best possible cleaning of your ducts' t2='Give you the highest grade installation' t3='Ensure the security of your unit well into the future' t4='Promise to be fair in honest in all negotiations' t5='Make sure you are happy and comfortable' t6='Send the most qualified technicians around' t7='Create an experience that you can depend on' t8='Do everything with accuracy and precision' extrastyles={{margin: '8% 0rem 1% -2.5%'}}/>
          </div>
